...
const hints = [
  "The 'Semantic' search uses AI to find related results in the whole Message, based on meaning. E.g. queries with “Holy Spirit” will also return results with “Holy Ghost”.",
  "The 'Exact' search type looks for exact matches of your search term within the Message database.",
  "The 'All Words' search type ensures all words in your query are included in the results.",
];
